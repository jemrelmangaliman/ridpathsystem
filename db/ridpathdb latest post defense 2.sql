...
INSERT INTO `enrollmentrecords` (`enrollmentID`, `studentID`, `strandID`, `enrollmentStatusID`, `studentTypeID`, `schoolYearID`, `transactionID`, `paymentterm`, `gradelevel`, `interest`, `enrollmentremarks`, `admissiondate`) VALUES
(27, 1, 4, 6, 1, 4, 0, '', '11', 'Computers', 'test', '2024-12-12'),
(31, 2, 6, 5, 1, 4, 0, '', '11', '', 'test', ''),
(33, 3, 4, 6, 1, 4, 0, 'Partial', '12', '', 'tewst', '2024-12-17');
...
(8, 'Cancelled'),
(9, 'Completed'),
(10, 'Enrolled - With Pending Balance');
...
INSERT INTO `examrecords` (`recordID`, `studentID`, `schoolYearID`, `examCategoryID`, `questionID`, `iscorrect`) VALUES
(76, 1, 4, 2, 72, 0),
(77, 1, 4, 2, 73, 0),
(78, 1, 4, 2, 74, 0),
(79, 1, 4, 2, 75, 0),
...
--
-- Dumping data for table `examscores`
--

INSERT INTO `examscores` (`scoreID`, `studentID`, `schoolYearID`, `examCategoryID`, `score`) VALUES
(7, 1, 4, 2, 3),
(8, 1, 4, 5, 6),
(9, 1, 4, 1, 5),
(10, 1, 4, 4, 2),
...
(49, 1, 27, '27-psa.jpg', 'psa', '../enrollment-files/27-psa.jpg'),
(50, 1, 27, '27-enrollmentform.jpg', 'enrollmentform', '../enrollment-files/27-enrollmentform.jpg'),
(52, 1, 27, '27-goodmoral.png', 'goodmoral', '../enrollment-files/27-goodmoral.png'),
(53, 2, 28, '28-psa.jpg', 'psa', '../enrollment-files/28-psa.jpg'),
(54, 2, 28, '28-reportcard.jpg', 'reportcard', '../enrollment-files/28-reportcard.jpg'),
(55, 2, 28, '28-enrollmentform.jpg', 'enrollmentform', '../enrollment-files/28-enrollmentform.jpg'),
(56, 2, 29, '29-psa.jpg', 'psa', '../enrollment-files/29-psa.jpg'),
(57, 2, 29, '29-reportcard.jpg', 'reportcard', '../enrollment-files/29-reportcard.jpg'),
(58, 2, 29, '29-enrollmentform.jpg', 'enrollmentform', '../enrollment-files/29-enrollmentform.jpg'),
(59, 2, 30, '30-psa.jpg', 'psa', '../enrollment-files/30-psa.jpg'),
(60, 2, 30, '30-reportcard.jpg', 'reportcard', '../enrollment-files/30-reportcard.jpg'),
(61, 2, 30, '30-enrollmentform.jpg', 'enrollmentform', '../enrollment-files/30-enrollmentform.jpg'),
(62, 2, 31, '31-psa.jpg', 'psa', '../enrollment-files/31-psa.jpg'),
(63, 2, 31, '31-reportcard.jpg', 'reportcard', '../enrollment-files/31-reportcard.jpg'),
(64, 2, 31, '31-enrollmentform.jpg', 'enrollmentform', '../enrollment-files/31-enrollmentform.jpg');
...
CREATE TABLE `paymentrecord` (
  ...
  `paymentModeID` int(254) NOT NULL,
  `amount` int(254) NOT NULL,
  `secondPaymentModeID` int(254) NOT NULL,
  `secondamount` int(254) NOT NULL,
  `totalpaymentamount` int(254) NOT NULL,
  `paymentterm` varchar(254) NOT NULL,
  `paymentdate` varchar(254) NOT NULL,
  `proofimgurl` varchar(254) NOT NULL,
  `secondproofimgurl` varchar(254) NOT NULL,
  `paymentremarks` varchar(300) NOT NULL,
  `secondpaymentremarks` varchar(300) NOT NULL,
...
INSERT INTO `paymentrecord` (`transactionID`, `enrollmentID`, `paymentModeID`, `amount`, `secondPaymentModeID`, `secondamount`, `totalpaymentamount`, `paymentterm`, `paymentdate`, `proofimgurl`, `secondproofimgurl`, `paymentremarks`, `secondpaymentremarks`, `status`) VALUES
(25, 33, 5, 2500, 6, 2500, 5000, 'Partial', '2024-12-17', '../paymentproofs/33-paymentproof.png', '../paymentproofs/33-paymentproof2.png', 're', 'et', ''),
(29, 33, 5, 5000, 7, 2235, 7235, 'Partial', '2024-12-17', '../paymentproofs/33-paymentproof.png', '', '', '', '');
...
INSERT INTO `registrationcodes` (`codeID`, `code`, `owneremail`, `used`) VALUES
(1, 'd6b53a71', 'laufeylin@gmail.com', 'Yes'),
(3, '618e239b', 'admin@example.com', 'No');
...
CREATE TABLE `schoolyear` (
  ...
  `studentcount` int(100) NOT NULL DEFAULT 0,
...
INSERT INTO `schoolyear` (`schoolYearID`, `schoolyearname`, `studentcount`, `isactive`, `startdate`, `enddate`, `formattedstartdate`, `formattedenddate`) VALUES
(4, 'S.Y. 2024-2025', 2, 'Yes', '2024-08-01', '2025-05-31', '2024-08-01T00:00:00', '2025-05-31T23:59:59'),
(5, 'S.Y. 2025-2026', 0, 'No', '2025-01-01', '2026-05-31', '2025-01-01T00:00:00', '2026-05-31T23:59:59'),
(6, 'tewtew', 0, 'No', '2024-10-01', '2024-10-31', '2024-10-01T00:00:00', '2024-10-31T23:59:59');
...
INSERT INTO `students` (`tempID`, `firstname`, `middlename`, `lastname`, `birthday`, `gender`, `address`, `email`, `contactnumber`, `studentnumber`, `password`, `userRole`, `isassignedtosection`, `isactive`, `profileimgurl`, `allowexam`) VALUES
(1, 'John', 'Titor', 'Smith', '2008-10-07', 'Male', 'Pulo, Cabuyao, Laguna, Philippines, Earth, Milky Way Galaxy', 'johnsmith@gmail.com', '09123456789', '20240001', 'password', 4, 0, '', '', 'No'),
(2, 'Erik', 'Smith', 'Titor', '2007-10-15', 'Male', 'test', 'eriktitor@gmail.com', '09123456789', '', 'password', 4, 0, '', '../userimages/s2.jpg', 'No'),
(3, 'Walter', 'Hartwell', 'White', '2009-10-07', 'Female', 'Test', 'walterwhite@gmail.com', '01234567890', '20240002', 'password', 4, 0, '', '', 'Yes'),
(6, 'John', 'Hinson', 'Hopkins', '2024-12-17', 'Male', '', 'johnhopkins@gmail.com', '01234567890', '', 'password', 4, 0, '', '', 'No'),
(10, 'Laufey', 'Lin', 'Jonsdottir', '2024-12-03', 'Male', '', 'laufeylin@gmail.com', '01234567890', '', 'password', 4, 0, '', '', 'No');
...
--
ALTER TABLE `enrollmentrecords`
  MODIFY `enrollmentID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `enrollmentstatus`
--
ALTER TABLE `enrollmentstatus`
  MODIFY `statusID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `examrecords`
  MODIFY `recordID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;

--
-- AUTO_INCREMENT for table `examscores`
--
ALTER TABLE `examscores`
  MODIFY `scoreID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `fileattachments`
--
ALTER TABLE `fileattachments`
  MODIFY `fileID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `paymentrecord`
  MODIFY `transactionID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `registrationcodes`
--
ALTER TABLE `registrationcodes`
  MODIFY `codeID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `sectionstudentlist`
  MODIFY `listItemID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `students`
  MODIFY `tempID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
