...
(29, 33, 5, 5000, 7, 2249, 7249, 'Partial', '2024-12-17', '../paymentproofs/33-paymentproof.png', '', '', '', '');
...
(1, 'John', 'Titor', 'Smith', '2008-10-07', 'Male', 'Pulo, Cabuyao, Laguna, Philippines, Earth, Milky Way Galaxy', 'johnsmith@gmail.com', '09123456789', '20240001', 'password', 4, 0, '', ''),
(2, 'Erik', 'Smith', 'Titor', '2007-10-15', 'Male', 'test', 'eriktitor@gmail.com', '09123456789', '', 'password', 4, 0, '', '../userimages/s2.jpg'),
(3, 'Walter', 'Hartwell', 'White', '2009-10-07', 'Female', 'Test', 'walterwhite@gmail.com', '01234567890', '20240002', 'password', 4, 0, '', ''),
(6, 'John', 'Hinson', 'Hopkins', '2024-12-17', 'Male', '', 'johnhopkins@gmail.com', '01234567890', '', 'password', 4, 0, '', ''),
(10, 'Laufey', 'Lin', 'Jonsdottir', '2024-12-03', 'Male', '', 'laufeylin@gmail.com', '01234567890', '', 'password', 4, 0, '', '');
...
--
ALTER TABLE `examrecords`
  MODIFY `recordID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;

--
-- AUTO_INCREMENT for table `examscores`
--
ALTER TABLE `examscores`
  MODIFY `scoreID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
