                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-success">For Resubmission</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered table-sm w-100" id="table">
                                        ...
                                        LEFT JOIN strands SD ON SD.strandID = ER.strandID WHERE ER.enrollmentStatusID = 3";
                                        ...
                                        while($DataArray = mysqli_fetch_assoc($fetchedData)){
                                            ...
                                            <tr>
                                                ...
                                                <a href="studentenrollmentdetails.php?tempID=<?php echo $ID;?>&pagetitle=For Resubmission&returnpage=forresubmission">
