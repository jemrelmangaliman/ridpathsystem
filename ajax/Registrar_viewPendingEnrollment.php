                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row w-100 mt-3 ml-1 mb-3">
                                                <div class="col">
                                                    <form action="../processes/Registrar_ApproveEnrollment.php" method="POST">
                                                        <input type="hidden" value="'.$enrollmentID.'" name="enrollmentID">
                                                        <button class="btn btn-success w-100 ml-auto mr-auto" id="page-btn" type="submit" name="Approve">Approve Enrollment</button>
                                                    </form> 
                                                </div>
                                                <div class="col">
                                                    <form action="../processes/Registrar_ReturnEnrollment.php" method="POST">
                                                        <input type="hidden" value="'.$enrollmentID.'" name="enrollmentID">
                                                        <button class="btn btn-danger w-100 ml-auto mr-auto" id="page-btn" type="submit" name="Reject">Return for Resubmission</button>
                                                    </form> 
                                                </div>
                                            </div>
                                        </div> 
