                ...
                <?php require '../shared/action-message.php'; ?>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-success">Manage Strand Miscellaneous Fees</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="row" id="page-btn-container">
                                        <div class="col-4">
                                        <button class="btn btn-success" id="page-btn" data-bs-toggle="modal" data-bs-target="#modal-Add"><i class="bi bi-plus-lg"></i> Add New Strand Misc Fee</button>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-hover table-bordered table-sm w-100" id="table">
                                        ...
                                        <?php
                                        $fetchQuery = "SELECT * FROM miscellaneousfees LEFT JOIN strands ON miscellaneousfees.strandID = strands.strandID";
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body p-4" style="font-family: Arial;">
                                            <h5>Edit Miscellaneous Fee Information</h5>
                    ...
                    <div class="modal fade" id="modal-Add" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body p-4" style="font-family: Arial;">
                                        <h5><b>Miscellaneous Fee Information</b></h5>
                                        <div class="container mb-2">
                                            <form action="../processes/Admin_AddMiscellaneousFee.php" method="POST">
                                                <div class="row mb-1">
                                                    <div class="col">
                                                        <small>Strand</small>
                                                ...
                                                <div class="row mt-3">
                                                    <center>
                                                        <div class="row">
                                                                ...
                                                                <button class="btn btn-success" id="page-btn" name="AddMiscFee" style="width:50%;">Submit</button>
                                                        </div>
                                                    </center>
                                                </div>
                                            </form>
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function (event) {
        ...
        var miscID = button.getAttribute('data-bs-miscID');
        ...
        var ajax = new XMLHttpRequest();
            ...
            ajax.open("GET", "../ajax/Admin_viewMiscellaneousFee.php?ID="+miscID, true);
            ajax.send(); 
    });
