                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Class List</div>
                                            <div class="dropdown">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" id="classListDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Select Class
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-wide" aria-labelledby="classListDropdown">
                                                    <a class="dropdown-item" href="#" onclick="showSubjects('Introduction to Programming')">Introduction to Programming</a>
                                                    <a class="dropdown-item" href="#" onclick="showSubjects('Data Structures')">Data Structures</a>
                                                    <a class="dropdown-item" href="#" onclick="showSubjects('Web Development')">Web Development</a>
                                                    <a class="dropdown-item" href="#" onclick="showSubjects('Database Management')">Database Management</a>
                                                    <a class="dropdown-item" href="#" onclick="showSubjects('Machine Learning')">Machine Learning</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
